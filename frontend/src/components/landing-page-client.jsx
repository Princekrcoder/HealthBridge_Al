      ...
      <div className="flex flex-col min-h-screen w-full">
        <header className="py-10 px-5 text-center">
          <div className="inline-flex items-center gap-4 mb-2.5">
            {/* Logo Update: Removed box styling, matched landing page size/style */}
        ...
        <main className="flex-1 w-full max-w-7xl mx-auto px-5 pb-10">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {roleCards.map((card) => (
              <div key={card.role} className="group bg-card/80 backdrop-blur-lg border border-white/70 rounded-3xl p-8 flex flex-col shadow-lg transition-all duration-300 hover:shadow-2xl hover:-translate-y-2 hover:border-primary">
